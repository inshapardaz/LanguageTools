    ...
    IDictionaryStore dictStore) =>
{
    ...
    foreach (var token in tokens)
    {
        ...
        if (coreWord.Length > 0)
        {
            ...
            Nawishta.Dictionary.DictionaryEntry? dictEntry = null;
    ...
    CancellationToken ct) =>
{
    ...
    var allArticles = new List<Nawishta.NaturalDictionary.Models.NaturalDictionaryArticle>();
    int p = 1;
    while (true)
    {
    ...
    CancellationToken ct) =>
{
    ...
    var articles = new List<Nawishta.NaturalDictionary.Models.NaturalDictionaryArticle>();
    ...
    CancellationToken ct) =>
{
    ...
    var article = new Nawishta.NaturalDictionary.Models.NaturalDictionaryArticle
    {
        DictionaryId = dictId,
...
app.MapPost("/api/spellcheck/check", async (
    ...
    INaturalDictionaryStore natStore,
    IDictionaryStore dictStore,
    IDbContextFactory<Nawishta.NaturalDictionary.Storage.NaturalDictionaryDbContext> dbFactory,
    CancellationToken ct) =>
{
    ...
    CancellationToken ct) =>
{
    ...
    {
        db.SpellCheckReplacements.Add(new Nawishta.NaturalDictionary.Storage.Entities.SpellCheckReplacementEntity
        {
            SourceWord = source,
...
record ArticleRequest(
    ...
    List<Nawishta.NaturalDictionary.Models.WordSense>? Senses,
    List<Nawishta.NaturalDictionary.Models.WordLink>? Links,
